$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/com/Practice/Features/InProgress/MyStoreProductSearch.feature");
formatter.feature({
...
formatter.step({
  "name": "User clickButton MyStoreAddToCart1_xpath",
  "keyword": "And "
});
formatter.step({
  "name": "User should see MyStoreSuccessfulCart_xpath from examples \u003cCartText\u003e",
  "keyword": "Then "
});
formatter.examples({
  "name": "",
...
formatter.match({
  "location": "GenericSteps.clickButton1(String)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "User should see MyStoreSuccessfulCart_xpath from examples Product successfully added to your shopping cart",
  "keyword": "Then "
});
formatter.match({
  "location": "GenericSteps.verifyTextfromExamples(String,String)"
