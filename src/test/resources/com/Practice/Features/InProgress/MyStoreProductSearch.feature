...
Feature: As a user, I want to verify MyStore Website Login
 ...
 @MyStoreProductSearch
  Scenario Outline: My Store - Login
   ...
   And    User clickButton MyStoreAddToCart1_xpath
   Then   User should see MyStoreSuccessfulCart_xpath from examples <CartText>
   
   
   
Examples: 

    |Browser|HomePageTitle|MyAccountPageText       |CreateAccountText|Search|CartText                                        |
    |Chrome |My Store     |Welcome to your account.|Create an account|Blouse|Product successfully added to your shopping cart|
